  ...
  const displayLoginRegisterButton = accessToken !== null ?
    ...
    (
      <div>
        ...
        <Link to={"/register"} className="btn_signup text-[#3D4449]  focus:ring-4 focus:ring-primary-300 font-medium text-[18px] lg:hover:bg-[black] lg:hover:text-[#fefefe]  border rounded-[40px] border-[#3D4449] border-solid  px-[20px] py-[8px] transition-all focus:outline-none">Sign Up</Link>
      </div>
    )
  return (
    <div >
      <header className='sticky top-0 bg-[#F4F1E4]' style={{ zIndex: 999 }}>
        <nav className="bg-[#F4F1E4] ">
          <div className="flex px-[30px] pt-[30px] justify-between gap-[400px] items-center ">
            <div className=''>
              <a href="/" className="">
            ...
            <div className="flex gap-[40px]  justify-center items-center w-full ">
              {/* nav content */}
              <div className="hidden justify-center items-center  lg:flex lg:order-1" id="mobile-menu-2">
                <ul className="flex justify-center items-center mt-4 font-medium gap-[30px] lg:mt-0">
                  <li>
