            ...
            <div className="flex gap-[60px] justify-center items-center w-full ">
              ...
              <div className="hidden justify-center items-center  lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  ...
                  <li>
                    <Link to={"/new-artwork"} className="block text-[18px] text-[#3D4449]   hover:text-[#F8939C] lg:hover:bg-transparent font-medium lg:border-0 lg:hover:text-primary-700 lg:p-0">Add Artwork</Link>
                  </li>
                  <li>
